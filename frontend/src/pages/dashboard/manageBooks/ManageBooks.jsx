...
const ManageBooks = () => {
  ...
  const { data, isLoading, error, refetch } = useFetchAllBooksQuery();
  ...
  // Extract books array from the data object
  const booksArray = data?.book || [];

  console.log("Books data:", data); // For debugging
